...
# Creating a list of tuples. This will help me to only generate the next question after the previous question was answered.
        questions = [
            ...
            ("Would you use your firearm in self-defense?", lambda x: x.lower() in ('yes', 'no'), "You answered {}."),
            ...
            ("Please select the first reason you can think of for why you decided to purchase a firearm:", lambda x: x.lower() in ('defense', 'constitution', 'sport'), "You chose {}."),
            ...
            ("Do you feel threatened by racially motivated hate groups in the U.S.?", lambda x: x.lower() in ('yes', 'no'), "You chose {}."),
            ("Do you feel scared of the police in the U.S.?", lambda x: x.lower() in ('yes', 'no'), "You chose {}."),
            ("Have you ever been victimized by police or racially motivated offenders in the U.S.?", lambda x: x.lower() in ('yes', 'no'), "You chose {}.")
        ]
